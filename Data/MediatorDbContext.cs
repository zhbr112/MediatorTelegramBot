...
public class MediatorDbContext:DbContext
{
    ...
    public DbSet<ProcessEditMediator> ProcessEditMediators { get; set; }

    public DbSet<User> Users { get; set; }

    public DbSet<Review> Reviews { get; set; }

    public DbSet<ProcessAddReview> ProcessAddReviews { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Admin>().HasData(
            ...
            new Admin { TelegramId = 2046655553 }
            );

        modelBuilder.Entity<User>()
            .HasMany(u => u.FavoriteMediators)
            .WithMany()
            .UsingEntity(j => j.ToTable("UserFavoriteMediators"));

        modelBuilder.Entity<Question>()
            .HasOne(q => q.Asker)
            .WithMany() // У одного юзера может быть много вопросов
